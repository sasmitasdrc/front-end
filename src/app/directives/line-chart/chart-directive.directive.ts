...
export class ChartDirectiveDirective implements OnInit  {
@ContentChild('linechartDirective') chartContainer: ElementRef;
@Input() private data: any;

   constructor(){
    //console.log("Enter in to directive..."+".."+this.chartContainer);
   }
...
//					            .attr("stroke-dashoffset", 0);
				...
				/*	*/
					if(dataNest.length > 1){
					    ...
					    .attr("xlink:href", 'http://devserver.sdrc.co.in:8095/scsl/resources/images/icons/svg_line_Selected.svg')
						...
						.attr("y", -64).attr("rx", 0).attr("ry",
								...
								;
						svg.append("svg:image")
					    .attr("xlink:href", 'http://devserver.sdrc.co.in:8095/scsl/resources/images/icons/svg_median_Selected.svg')
					...
					function rectClickHandler(series, selectedSvg, button, median) {
						...
						if (selectedSvg.find("#tag"+ series)
							...
							if(median)
								button.attr("xlink:href", 'http://devserver.sdrc.co.in:8095/scsl/resources/images/icons/svg_median_Selected.svg');
							else
								button.attr("xlink:href", 'http://devserver.sdrc.co.in:8095/scsl/resources/images/icons/svg_line_Selected.svg');
						} else {
							disName = "none";
							if(median)
								button.attr("xlink:href", 'http://devserver.sdrc.co.in:8095/scsl/resources/images/icons/svg_median_not_Selected.svg').attr("id",  'not_median_Selected_img1');
							else
								button.attr("xlink:href", 'http://devserver.sdrc.co.in:8095/scsl/resources/images/icons/svg_line_not_Selected.svg').attr("id",  'not_line_Selected_img1');
							fillColor = "#464646";
						}
